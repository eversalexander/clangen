...
class Name():
    ...
    normal_suffixes = [  # common suffixes
        ...
        # regular suffixes
        "back", "blossom", "breeze", "briar", "brook", "burr", "cloud", "creek",
        "ear", "ears", "eye", "eyes", "face", "fall", "fang", "feather", "fern", "fire",
        "flame", "flight", "flower", "frost", 
        "jaw", "leaf", "leap", "leg", "mask",
        "moon", "nose", "pad", "patch",
        "petal", "pool",
        "scar", "sky", "song", 
        "speck", "spot", "spots", "step",
        "storm", "stream", "strike", "stripe",
        "tail", "throat", "tuft",
    ]
    ...
    tortie_pelt_suffixes = {
        ...
        'tortietabby': ['stripe', 'feather', 'leaf', 'stripe', ],
        'tortiebengal': ['dapple', 'speckle', 'spots', 'speck', 'freckle'],
        'tortiemarbled': ['stripe', 'feather', 'leaf', 'stripe', 'shade'],
    ...
    normal_prefixes = [
        ...
        'Amber', 'Ant', 'Antler', 'Apple', 'Apricot', 'Arc', 'Arch',
    ...
    loner_names = [
        ...
        "Jessica", "Laku", "Dragonfly", "Xek", "Silva", "Dreamy", "Decay",
        ...
        "Marceline", "Whisper", "Skrunkly", "Crunchwrap", "Rio", "Steven", "Pear",
        "Sekhmet", "Melon", "Ember", "Loona", "Saki", "Tiny", "Sandy",
        "Miles", "Mini", "Judas", "Zim", "Vinyl", "Fudge", "Trixie", "Sunset",
        ...
        "Hot Sauce", "Habanero", "Taco", "Cheetoman", "Queso", "Ruby",
