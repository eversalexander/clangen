...
class Name(object):
    ...
    normal_suffixes = [
        ...
        "brook", "burr", "cloud", "creek", "daisy",
        "drift", "dusk", "dust", "ear", "ears", "eye", "eyes", "face", "fall", "fang",
        "feather", "fire", "flame", "flight", "flower",
        "frost", 
        "jaw", "leaf",
        "leap", "leg", "mask", "mist", "moon", 
        "nose", "pad", "patch", "petal",
        "pond", "pool", "run", "runner",
         "seed", "shade", "shadow", "shell", "shine", "sight", "sky", "snow",
        "song", "spark", "speck", "speckle", "spot", "spots", "spring",
        "stalk", "stem", "step", "stone", "storm", "streak", "stream", "strike", "stripe", "sun",
        "tail", "tree", "throat", "tuft", "water", 
